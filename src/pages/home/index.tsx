...
const HomePage: React.FC<Props> = ({}) => {
  ...
  return (
    <div className="flex flex-col gap-4 p-12">
      <Card>
        <div className="fs-14 lh-16 fw-bold">利润 & 损失</div>
        <div className="mt-8 fs-24 fw-bold lh-28">{formatPrice(price)}</div>
        ...
        <div className="flex items-center justify-between mt-8 fs-14 lh-16 color-[#6A6B82]">
          <span>收入</span>
          <span>支出</span>
        </div>
        <Tabs
